...
%
%% 
% function[] = HOanaGrouped2Imar(TPN)
...
%%
dPosPassF = Grouped.Pos;  % create directory of passing dots positions
...
dVolpassF = Grouped.Vol.*xyzVolConv;
...
dPosNoPassF = Dots.Pos(passingIDs==0,:); %(dotPassingID,:); % create directory of passing dots positions
...
xyzVolConv = xyum^2*zum;
dVolNopassF = Dots.Vol(passingIDs==0).*xyzVolConv;
